...
public class BMPWriter
	...
	public static void main(String[] args) throws Exception {
		...
		weka.gui.treevisualizer.Node top = builder.create(new java.io.StringReader(
				"digraph atree { top [label=\"the top\"] a [label=\"the first node\"] b [label=\"the second nodes\"] c [label=\"comes off of first\"] top->a "
						+ "top->b b->c }"));
