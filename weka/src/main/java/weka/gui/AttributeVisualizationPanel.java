	...
	public void paintComponent(Graphics g) {
		...
		if (m_as != null) { // If calculations have been done and histogram/barplot
			...
			if (m_threadRun == false && m_displayCurrentAttribute) { // calculation
				...
				} else if (m_as.numericStats != null// <--end if m_as.nominalCount!=null
						&& (m_histBarClassCounts != null || m_histBarCounts != null)) { // if the current attribute is numeric then draw a histogram.
