...
/**
 * <!-- globalinfo-start -->
 * * A filter that uses a PartitionGenerator to generate partition membership values; filtered instances are composed of these values plus the class
 * attribute (if set in the input data) and rendered as sparse instances. See Section 3 of<br>
 * * Eibe Frank, Bernhard Pfahringer: Propositionalisation of Multi-instance Data Using Random Forests. In: AI 2013: Advances in Artificial Intelligence,
 * 362-373, 2013.
 * * <br><br>
 * <!-- globalinfo-end -->
 *
