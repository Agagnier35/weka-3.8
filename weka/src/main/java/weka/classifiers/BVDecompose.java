 ...
 * <br/>
 * Ron Kohavi, David H. Wolpert: Bias Plus Variance Decomposition for Zero-One Loss Functions. In: Machine Learning: Proceedings of the Thirteenth
 * International Conference, 275-283, 1996.
 * <p/>
 <!-- globalinfo-end -->
 *
...
public class BVDecompose
	...
	public String[] getOptions() {
		...
		options[current++] = "-x";
		options[current++] = "" + getTrainIterations();
		options[current++] = "-T";
		options[current++] = "" + getTrainPoolSize();
		options[current++] = "-s";
