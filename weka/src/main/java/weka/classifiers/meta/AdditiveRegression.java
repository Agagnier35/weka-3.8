 ...
 * previous iteration. Prediction is accomplished by adding the predictions of each classifier. Reducing the shrinkage (learning rate) parameter helps
 * prevent overfitting and has a smoothing effect but increases the learning time.<br/>
 * <br/>
