...
public class Apriori extends AbstractAssociator implements OptionHandler,
	...
	public Enumeration<Option> listOptions() {
		...
		String string1 = "\tThe required number of rules. (default = " + m_numRules
				...
				"\tthe given level. Slower. (default = no significance testing)", string8 = "\tIf set the itemsets found are also output. (default = no)",
				string9 = "\tIf set class association rules are mined. (default = no)", string10 = "\tThe class index. (default = last)", stringType =
				"\tThe metric type by which to rank rules. (default = "
