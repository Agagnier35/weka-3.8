...
public class AprioriItemSet extends ItemSet implements Serializable,
	...
	public final ArrayList<Object>[] generateRulesBruteForce(double minMetric,
		...
		ArrayList<Object> premises = new ArrayList<Object>(), consequences = new ArrayList<Object>(), conf = new ArrayList<Object>(), lift =
				new ArrayList<Object>(), lev = new ArrayList<Object>(), conv = new ArrayList<Object>();
		@SuppressWarnings("unchecked")
