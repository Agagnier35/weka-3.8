...
/**
 * <!-- globalinfo-start -->
 * Applies the given filter before calling the given neighbour search method. The filter must not change the size of the dataset or the order of the
 * instances! Also, the range setting that is specified for the distance function is ignored: all attributes are used for the distance calculation.
 * <p/>
 * <!-- globalinfo-end -->
 *
 * <!-- options-start -->
